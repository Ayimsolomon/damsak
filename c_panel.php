...
<body>
    ...
    <div class="container-fluid">
                ...
                <div class="offcanvas offcanvas-end " style="width: 14%;background-color:#01040f;" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                            ...
                            <li class="nav-item mt-4">
                                <a class="nav-link active" data-bs-custom-class="custom-tooltip" aria-current="page" href="logout.php" data-bs-toggle="tooltip" data-bs-placement="right" title="Logout">
                                    <i class="fa fa-sign-out" id="tooltip" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="log out"></i>
                                </a>
        ...
        <br><br><br><br>
        <h4 class="d-flex justify-content-center mt-2 mb-4 bg-primary text-white"> <?php echo "HELLO $_SESSION[admin_name] WELCOME BACK. " ?></h4>
        ...
        <div class="container-fluid d-flex justify-content-center mt-4 mb-4">
            ...
            <div class="container" id="post" style="display:none;">
                ...
                <form action="" method="Post" class="pt-4" enctype='multipart/form-data'>
                    ...
                    <input type="submit" class="form-control mb-4 btn btn-secondary" name="submit" value="Post" id="">
                </form>
            </div>
        ...
        <section class="row p-2 container-fluid">
            ...
            <div class="col p-2">
                ...
                <form action="" method="post" class="form">
                    <input type="text" name="id" id="" class="form-control" placeholder="id"><br>
        ...
        <main class="row p-2 container_fluid">
            ...
            <div class="col p-2">
                ...
                <form action="" method="post" class="form">
                    <input type="text" name="skill_catalog" id="" class="form-control" placeholder="UUID"><br>
            ...
            <div>
                ...
                if (isset($_POST['select'])) {
                    ...
                    $UUID = $_POST["skill_catalog"];

                    //$update=" UPDATE `data` SET `full_name`='$_POST[full_name]',`email`=' $_POST[email]' WHERE `UUID`='$_POST[UUID]'";
                    $select = "SELECT * FROM registration WHERE skill_catalog='$_POST[skill_catalog]'";
                    $query = mysqli_query($connect, $select);
                    $rows = mysqli_num_rows($query);
                    $fetch = mysqli_fetch_assoc($query);
                    if ($rows > 0) {
                        $query = mysqli_query($connect, $select);
                        echo "<table class='table table-striped'><tr><th>UUID</th><th>First_name</th><th>Surname</th><th>Email</th><th>skill_catalog</th><th>Credentials</th></tr> ";
                        while ($fetch = mysqli_fetch_assoc($query)) {
                            echo " <tr><td>" . $fetch["UUID"] . "</td><td>" . $fetch["first_name"] . "</td><td>" . $fetch["surname"] . "</td><td>" . $fetch["email"] . "</td><td>" . $fetch["skill_catalog"] . "</td><td>" . '<img src="' . $fetch['image'] . '" width="100px" height="100px" ">' . "</td></tr>";
                        }
                        echo "</table>";
                    } else {
                        echo " <script> alert('0 record found') </script>";
